...
export default (() => {
  ...
  const Head: QuartzComponent = ({
    ...
    if (cfg.generateSocialImages) {
      // Generate folders for social images (if they don't exist yet)
    ...
    // Use default og image if filePath doesn't exist (for autogenerated paths with no .md file)
    ...
    return (
      <head>
        ...
        {/* don't set width and height if unknown (when using custom frontmatter image) */}
        {!frontmatterImgUrl && (
          <>
